package net.doglover.dlrlaterdiscsforge;

import com.mojang.logging.LogUtils;
import net.doglover.dlrlaterdiscsforge.item.ModCreativeModeTabs;
...
@Mod(DlrLaterDiscsForge.MOD_ID)
public class DlrLaterDiscsForge {
    public static final String MOD_ID = "dlrlaterdiscsforge";
    private static final Logger LOGGER = LogUtils.getLogger();

    public DlrLaterDiscsForge(FMLJavaModLoadingContext context) {

...
public class ModCreativeModeTabs {
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, DlrLaterDiscsForge.MOD_ID);

    public static final RegistryObject<CreativeModeTab> LATERDISCS_TAB = CREATIVE_MODE_TABS.register("laterdiscs_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.BLANK_MUSIC_DISC.get()))
                    .title(Component.translatable("creativetab.laterdiscs_tab"))
